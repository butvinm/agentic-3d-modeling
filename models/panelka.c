...
const Scene SCENE = {
    ...
    .description =
        ...
        "A balcony is four pieces: a concrete slab with the rusted steel that carries its front, a painted sheet standing on that slab and inset from its edge so the cantilever it hangs from stays visible, an enclosure of thin painted frames over six lights, and the glass in it. The sheet reaching the slab\'s own outer face is what made a review round read the enclosed ones as coloured rectangles applied to the wall.\n"
